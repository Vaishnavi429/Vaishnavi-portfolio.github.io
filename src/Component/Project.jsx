...
export default function Project() {
  ...
  return (
    <div name="project" className='w-full h-screen bg-gradient-to-b from-gray-800 to-black'>
      <div className='max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full text-white'>
        ...
        <div className='w-full grid grid-cols-2 sm:grid-cols-3' >
          ...
          {project.map(({ id, src, demohref, codehref }) => (
            <div key={id} className='shadow-md hover:scale-105 duration-500 py-2 rounded-lg shadow-gray-500 p-2 m-2'>
